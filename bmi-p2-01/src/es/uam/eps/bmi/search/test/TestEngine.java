...
//        new DiskIndexBuilder().build(collPath, basePath + "/disk");
...
//        testSearchPerformance("1k", "index/1k", "obama family tree");
//        testSearchPerformance("10k", "index/10k", "obama family tree");
        testSearchPerformance("100k", "index/100k", "obama family tree");
    }
...
//        System.out.println("\tRAMIndex:\t" + diskSpace(baseIndexPath + "/ram") + "K");
    ...
    static void testSearchPerformance(String collName, String baseIndexPath, String query) throws IOException {
        System.out.println("-----------------------");
